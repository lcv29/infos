...
$lang_next = "suivant";
$lang_of = "sur";
$lang_stop_slideshow = "arréter défilement";
$lang_start_slideshow = "défilement auto.";
$lang_img_hover = "click pour image suivante...";
...
if ( !file_exists("$path_to_images/$heading_info_file")) {
	$header = "Adaptation du PHPSlideshow de Greg Lawler - zinkwazi.com";
	$title = "<a href=\"http://www.zinkwazi.com/\">Adaptation du PHPSlideshow de Greg Lawler - zinkwazi.com</a>";
}
else {
